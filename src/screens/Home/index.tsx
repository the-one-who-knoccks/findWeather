...
import CardTimeTemperature from "../../components/CardTimeTemperature";
...
const FullContent = () => (
  <>
    ...
    <WeatherInfo data={dataWeatherInfo} />
    ...
    <CardTimeTemperature data={dataCardTimeTemperature} />
